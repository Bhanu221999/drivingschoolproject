...
(function() {
  ...
  function J(h, m, w, v, Fa) {
      ...
      v.push([h, m, w, Fa]);
      return h.addEventListener ? (h.addEventListener(m, w, Fa),
  ...
  function gb(h) {
      ...
      if (!h._dropdownMenu && h.exportEnabled && v) {
          ...
          J(w, "mouseout", function() {
              m || (this.style.backgroundColor = h.toolbar.backgroundColor,
  ...
  function hb(h) {
      if (!ib) {
          ...
          h.creditText = X("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"),
  ...
  function ua(h, m, w) {
      ...
      m.getAttribute("state") !== w && (m.setAttribute("state", w),
  ...
  function Ra(h, m, w, s, v) {
      ...
      "undefined" !== typeof v && (h = Math.max(v, h)));
  ...
  function V(h, m, w, v, y) {
      ...
      h = {};
      this.theme && s(this.parent) && s(m) && s(v) ? h = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === v ? h = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (v = Math.min(this.parent.themeOptions[m].length - 1, v),
  ...
  var fb = function() {
    ...
    , ea = function(h, m, w) {
      ...
      for (J = F = L = Q = N = 0; 0 < M.length; )
          ...
          "#" === m || "0" === m)
              ...
              F = J,
              J = 0,
              0 < D.length && (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""),
      ...
      for (M = !1; 0 < T.length; )
          m = T.shift(),
          "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (y += h.shift(),
          M = !0) : "0" === m && (y += "0",
          M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""),
    ...
    , Na = function(h) {
      var m = 0
        , w = 0;
      h = h || window.event;
      h.offsetX || 0 === h.offsetX ? (m = h.offsetX,
      w = h.offsetY) : h.layerX || 0 == h.layerX ? (m = h.layerX,
      w = h.layerY) : (m = h.pageX - h.target.offsetLeft,
  ...
  V.prototype.addTo = function(h, m, s, v) {
      ...
      h.splice(s, 0, m),
      v && (this.stockChart || this.chart || this).render()) : window.console && (y.publicProperties && y.publicProperties.hasOwnProperty(h) && "readOnly" === y.publicProperties[h] ? window.console.log('Property "' + h + '" is read-only.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."))
  }
  ;
  ...
  xa.prototype.setLayout = function() {
      if (this.text) {
          var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(), v = m.x1, y = m.y1, F = 0, H = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, J;
          ...
          F = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4),
          H = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4),
          H = 0.5 * m.height - 4));
          var M;
          ...
          J = "top") : "bottom" === this.verticalAlign && (y = m.y2 - 2 - M.height,
          J = "bottom"),
          ...
          this.width = M.width,
          this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (v = m.x1 + 2,
          y = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2),
          F = -90,
          J = "left",
          this.width = M.height,
          this.height = M.width) : "right" === this.horizontalAlign ? (v = m.x2 - 2,
          y = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2),
          F = 90,
          J = "right",
          this.width = M.height,
          this.height = M.width) : "center" === this.horizontalAlign && (y = h.y1 + (h.height / 2 - M.height / 2),
  ...
  Ta.prototype.get = function(h, m) {
      var v = null;
      0 < this.pool.length ? (v = this.pool.pop(),
      La(v, h, m)) : v = sa(h, m);
      return v
  }
  ;
  ...
  y = Oa.Chart = function() {
      ...
      function m(a, d, c) {
          ...
          v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d),
          ...
          this.windowResizeHandler = J(window, "resize", function() {
      ...
      function y(a, d, c, b, e, f, l, u, A, k) {
          ...
          a.beginPath();
          A && 0 < u.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p),
          ...
          a.beginPath();
          A && 0 < l.thickness ? (a.moveTo(b - n, c),
          a.lineTo(b - n, e),
          a.moveTo(d + n, c),
          a.lineTo(d + n, e)) : 0 < l.thickness && (a.moveTo(d, c + n),
          a.lineTo(b, c + n),
          a.moveTo(d, e - n),
          a.lineTo(b, e - n));
          a.stroke();
      ...
      m.prototype._updateOptions = function() {
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
              ...
              J(this._resetButton, "touchstart", function(a) {
                  d = !0
              }, this.allDOMEventHandlers),
              ...
              J(this._resetButton, "mouseover", function() {
                  d || (oa(a._resetButton, {
                      backgroundColor: a.toolbar.backgroundColorOnHover,
              ...
              J(this._resetButton, "mouseout", function() {
                  d || (oa(a._resetButton, {
                      backgroundColor: a.toolbar.backgroundColor,
                      color: a.toolbar.fontColor,
                      transition: "0.4s",
      ...
      m.prototype.setLayout = function() {
          ...
          c ? (Ka(this._zoomButton, this._resetButton),
          ...
          for (d = 0; d < this._axes.length; d++)
              if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                  v ? (this._breaksCanvas = sa(this.width, this.height, !0),
          ...
          for (d = 0; d < this.plotInfo.plotTypes.length; d++)
              for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                  var u = f.plotUnits[l]
                    , A = null;
                  u.targetCanvas = null;
                  this.animatedRender && (u.targetCanvas = sa(this.width, this.height),
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  ...
                  for (A = 0; A < u.dataPoints.length; A++) {
                      ...
                      u.dataPoints[A].x.getTime ? (f = !0,
                      b = u.dataPoints[A].x.getTime()) : b = u.dataPoints[A].x;
                      e = u.dataPoints[A].y;
                      b < c.min && (c.min = b);
                      b > c.max && (c.max = b);
                      ...
                      if (0 < A) {
                          ...
                          null !== e && null !== u.dataPoints[A - 1].y && (a.axisY.logarithmic ? (r = e / u.dataPoints[A - 1].y,
                          1 > r && (r = 1 / r),
                          d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - u.dataPoints[A - 1].y,
                          0 > r && (r *= -1),
              ...
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], u = [], A = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  for (q = 0; q < p.dataPoints.length; q++) {
                      ...
                      if (0 < q) {
                          ...
                          null !== e && null !== p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (x = e / p.dataPoints[q - 1].y,
                          1 > x && (x = 1 / x),
                          d.minDiff > x && 1 !== x && (d.minDiff = x)) : (x = e - p.dataPoints[q - 1].y,
                          0 > x && (x *= -1),
                      ...
                      if (b < m && !g)
                          ...
                          0 <= e ? l[b] ? l[b] += e : (l[b] = e,
                          A = Math.min(e, A)) : u[b] ? u[b] += e : (u[b] = e,
                          k = Math.max(e, k)))
                      }
                  }
          ...
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                  ...
                  if (u.dataPoints[A].x && u.dataPoints[A].x.getTime || "dateTime" === u.xValueType)
                      f = !0;
                  for (A = 0; A < u.dataPoints.length; A++)
                      "undefined" !== typeof u.dataPoints[A].isCumulativeSum && !0 === u.dataPoints[A].isCumulativeSum ? (u.dataPointEOs[A].cumulativeSumYStartValue = 0,
                      u.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum,
                      u.dataPoints[A].y = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof u.dataPoints[A].isIntermediateSum && !0 === u.dataPoints[A].isIntermediateSum ? (u.dataPointEOs[A].cumulativeSumYStartValue = p,
                      u.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum,
                      u.dataPoints[A].y = 0 === A ? 0 : b,
                      p = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum,
                      b = 0) : (e = "number" !== typeof u.dataPoints[A].y ? 0 : u.dataPoints[A].y,
                      u.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum,
                  ...
                  for (A = 0; A < u.dataPoints.length; A++)
                      ...
                      b < c.min && (c.min = b),
                      b > c.max && (c.max = b),
                      u.dataPointEOs[A].cumulativeSum < d.min && (d.min = u.dataPointEOs[A].cumulativeSum),
                      u.dataPointEOs[A].cumulativeSum > d.max && (d.max = u.dataPointEOs[A].cumulativeSum),
                      0 < A && (a.axisX.logarithmic ? (p = b / u.dataPoints[A - 1].x,
                      1 > p && (p = 1 / p),
                      c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - u.dataPoints[A - 1].x,
                      0 > p && (p *= -1),
                      c.minDiff > p && 0 !== p && (c.minDiff = p)),
                      null !== e && null !== u.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = u.dataPointEOs[A].cumulativeSum / u.dataPointEOs[A - 1].cumulativeSum,
                      1 > e && (e = 1 / e),
                      d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = u.dataPointEOs[A].cumulativeSum - u.dataPointEOs[A - 1].cumulativeSum,
                      0 > e && (e *= -1),
                      ...
                      !(b < q) || k) {
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          0 < A && (u.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[A - 1].cumulativeSum),
      ...
      m.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, l = ka("indexLabelFontColor", n.dataPoint, n.dataSeries), r = ka("indexLabelFontSize", n.dataPoint, n.dataSeries), u = ka("indexLabelFontFamily", n.dataPoint, n.dataSeries), A = ka("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = ka("indexLabelFontWeight", n.dataPoint, n.dataSeries), h = ka("indexLabelBackgroundColor", n.dataPoint, n.dataSeries);
              ...
              if (null !== C && "" !== C) {
                  ...
                  if ("normal" === this.plotInfo.axisPlacement) {
                      ...
                      "inside" !== z ? (e = c.y1,
                      f = c.y2,
                      0 < B ? (g = n.point.y + ("horizontal" === E ? r / 2 : 0) - k - u - b,
                      g < e && (g = "auto" === z ? Math.max(n.point.y, e) + r / 2 + u : e + r / 2 + u,
                      w = g + k > n.point.y)) : (g = n.point.y + r / 2 + u + b,
                      g > f - k && (g = "auto" === z ? Math.min(n.point.y, f) + r / 2 - k - u : f + r / 2 - k,
                      w = g < n.point.y))) : (e = Math.max(n.bounds.y1, c.y1),
                      f = Math.min(n.bounds.y2, c.y2 - k + r / 2),
                      b = 0 <= p.indexOf("range") || "error" === p ? 0 < B ? Math.max(n.bounds.y1, c.y1) + r / 2 + u : Math.min(n.bounds.y2, c.y2) + r / 2 - k + u : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === E ? u : 0),
                      0 < B ? (g = Math.max(n.point.y, b),
                      ...
                      "inside" !== z ? (e = c.x1,
                      f = c.x2,
                      0 > B ? (q = n.point.x - ("horizontal" === E ? A : A - r / 2) - l - b,
                      q < e && (q = "auto" === z ? Math.max(n.point.x, e) + l : e + l,
                      w = q + A > n.point.x)) : (q = n.point.x + ("horizontal" === E ? 0 : r / 2) + l + b,
                      q > f - A - l - b && (q = "auto" === z ? Math.min(n.point.x, f) - ("horizontal" === E ? A : A / 2) - l : f - A - l,
                      w = q < n.point.x))) : (e = Math.max(n.bounds.x1, c.x1),
                      Math.min(n.bounds.x2, c.x2),
                      b = 0 <= p.indexOf("range") || "error" === p ? 0 > B ? Math.max(n.bounds.x1, c.x1) + r / 2 + l : Math.min(n.bounds.x2, c.x2) - A / 2 - l + ("horizontal" === E ? 0 : r / 2) : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === E ? 0 : r / 2),
                  ...
                  0 <= p.indexOf("bar") || "error" === p && n.axisSwapped ? d.lineTo(q + (0 < n.direction ? -l : A + l) + ("vertical" === E ? -r / 2 : 0), g + ("vertical" === E ? -k / 2 : k / 2 - r / 2) - u) : 0 <= p.indexOf("column") || "error" === p && !n.axisSwapped ? d.lineTo(q + A / 2 - ("horizontal" === E ? 0 : r / 2), g + ("vertical" === E ? (g - k < n.point.y ? 0 : -k) + u : (g - r / 2 < n.point.y ? k : 0) - r / 2)) : d.lineTo(q + A / 2 - ("horizontal" === E ? 0 : r / 2), g + ("vertical" === E ? g - k < n.point.y ? 0 : -k : (g - r / 2 < n.point.y ? k : 0) - r / 2)),
                  d.stroke())
              }
          }
          d = {
              ...
              for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                  ...
                  if (0 < n.length) {
                      for (var E = !1, t = 0; t < n.length; t++)
                          ...
                          !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !E)))
                              if ("number" !== typeof n[t].y)
                                  0 < t && !(k.connectNullData || E || m) && (c.stroke(),
                                  v && b.stroke()),
                                  E = !0;
                              else {
      ...
      m.prototype.renderSpline = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var l = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                  ...
                  if (0 < n.length)
                      ...
                      m = 0; m < n.length; m++)
                          ...
                          !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                              if ("number" !== typeof n[m].y)
                                  0 < m && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q,
                                  p = k.nullDataLineDashType) : (d(s),
                                  s = [])),
                                  x = !0;
                              else {
                                  ...
                                  b.setLineDash && (n[m].lineDashType ? (p = n[m].lineDashType,
              ...
              W.drawMarkers(l);
              v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
              ...
              for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                  ...
                  if (0 < r.length)
                      for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
                          if (r[f].getTime ? A = r[f].x.getTime() : A = r[f].x,
                          !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
      ...
      m.prototype.renderStackedColumn = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = [], l = [], u = [], A = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                      ...
                      for (var x = 5 < g && m.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                              ...
                              0 <= t[k].y) {
                                  ...
                                  C = p + B,
                                  p = q + B,
                                  a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - C) && (C = e.y2),
                                  l[b] = B + (C - p);
                              b = t[k].color ? t[k].color : m._colorSet[k % m._colorSet.length];
                              ca(c, s, p, E, C, b, 0, null, x && 0 <= t[k].y, 0 > t[k].y && x, !1, !1, m.fillOpacity);
                              b = m.dataPointIds[k];
                  ...
                  if (0 < t.length) {
                      ...
                      for (k = 0; k < t.length; k++)
                          ...
                          !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                              ...
                              else if (n = a.axisY.convertValueToPixel(s),
                              0 <= t[k].y) {
                                  var B = f[b] ? f[b] : 0;
                                  s = q + B;
                                  n += B;
                                  ...
                                  s = n - B,
                                  n = q - B,
                                  a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - s) && (s = e.x1),
                                  l[b] = B + (n - s);
                              b = t[k].color ? t[k].color : m._colorSet[k % m._colorSet.length];
      ...
      m.prototype.renderArea = function(a) {
          var d, c;
          function b() {
              C && (0 < g.lineThickness && f.stroke(),
              a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? E = z : 0 > a.axisY.viewportMaximum ? E = u.y1 : 0 < a.axisY.viewportMinimum && (E = z),
              f.lineTo(m, E),
              f.lineTo(C.x, E),
              f.closePath(),
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  ...
                  A = [];
                  d = !0;
                  var h = 0, m, t, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), E, C = null;
                  if (0 < r.length) {
      ...
      m.prototype.renderSplineArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                  ...
                  l = Q(l);
                  e.fillStyle = l;
                  var l = [], q = 0, g, r, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, t = null, s = [];
                  if (0 < p.length) {
                      ...
                      for (r = !1; q < p.length; q++)
                          ...
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))
                              if ("number" !== typeof p[q].y)
                                  0 < q && !r && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y,
                                  B = n.nullDataLineDashType) : (d(),
                                  s = [])),
                                  r = !0;
                              else {
                                  ...
                                  b.setLineDash && (p[q].lineDashType ? (B = p[q].lineDashType,
                  ...
                  if (0 < r.length) {
                      ...
                      for (; h < r.length; h++)
                          ...
                          !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                              var aa = t;
                              "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(),
                              ...
                              y = r[h].lineColor || w,
                              f.strokeStyle = y,
                              f.setLineDash && (r[h].lineDashType ? (S = r[h].lineDashType,
      ...
      m.prototype.renderStackedArea = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = v ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = [], u = this.plotArea, h = [], k = [], n = [], p = [], q = 0, g, r, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, t, x, z;
              v && s.beginPath();
              b.save();
              v && s.save();
              b.beginPath();
                      ...
                      for (var aa = !0, q = 0; q < n.length; q++) {
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                              if ("number" !== typeof fa.y)
                                  ...
                                  h[f] = m - r;
                                  x || aa ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || z === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = k.pop(),
                                  z = k[k.length - 1],
                                  d(),
                                  b.moveTo(t.x, t.y),
                                  k.push(z),
                                  ...
                                  S = w[q].lineColor || y,
                                  b.strokeStyle = S,
                                  b.setLineDash && (w[q].lineDashType ? (z = w[q].lineDashType,
                                  b.setLineDash(N(z, B.lineThickness))) : (z = B.lineDashType,
                                  b.setLineDash(D))));
      ...
      m.prototype.renderStackedArea100 = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx
            , b = v ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = this.plotArea, u = [], h = [], k = [], n = [], p = [], q = 0, g, r, m, s, t, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z = this._eventManager.ghostCtx;
              b.save();
              v && z.save();
              b.beginPath();
              ...
              b.clip();
              v && (z.beginPath(),
              z.rect(l.x1, l.y1, l.width, l.height),
              z.clip());
              for (var e = [], E = 0; E < a.dataSeriesIndexes.length; E++) {
                      ...
                      for (var aa = !0, q = 0; q < n.length; q++) {
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                              if ("number" !== typeof fa.y)
                                  ...
                                  h[f] = x - r;
                                  s || aa ? (!s && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || t === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (s = k.pop(),
                                  t = k[k.length - 1],
                                  d(),
                                  b.moveTo(m.x, m.y),
                                  k.push(t),
                                  ...
                                  b.setLineDash(N(t, B.lineThickness))) : (t = B.lineDashType,
                                  b.setLineDash(F))));
                                  if (0 <= B.dataPointIndexes[f]) {
                  ...
                  if (0 < n.length) {
                      ...
                      for (var p = 0, q = 0, e = 0; e < n.length; e++)
                          ...
                          !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                              ...
                              c.globalAlpha = 1;
                              Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e],
                              ...
                              p = Q(p),
                              v && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
              ...
              for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  if (0 < x.length)
                      for (var z = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)
                          if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x,
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] && "number" === typeof x[u].y[1] && "number" === typeof x[u].y[2] && "number" === typeof x[u].y[3]) {
                              ...
                              "candlestick" === t.type ? (c.moveTo(h - y, n),
                              c.lineTo(h - y, Math.min(k, q)),
                              c.stroke(),
                              c.moveTo(h - y, Math.max(k, q)),
                              c.lineTo(h - y, p),
                              c.stroke(),
                              ca(c, E, Math.min(k, q), C, Math.max(k, q), x[u].y[0] <= x[u].y[3] ? t.risingColor : f, B, e, z, z, !1, !1, t.fillOpacity),
                              v && (e = Q(D),
                              b.strokeStyle = e,
                              b.moveTo(h - y, n),
                              ...
                              b.lineTo(h - y, p),
                              b.stroke(),
                              ca(b, E, Math.min(k, q), C, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(h - y, n),
                              c.lineTo(h - y, p),
                              c.stroke(),
                              c.beginPath(),
                              c.moveTo(h, k),
      ...
      m.prototype.renderBoxAndWhisker = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            ...
            , b = this._eventManager.ghostCtx;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = this.plotArea, l = 0, u, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff;
              isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range));
              ...
              for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                  ...
                  if (0 < z.length)
                      for (var E = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < z.length; l++)
                          if (z[l].getTime ? g = z[l].x.getTime() : g = z[l].x,
                          !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[l].y) && z[l].y.length && "number" === typeof z[l].y[0] && "number" === typeof z[l].y[1] && "number" === typeof z[l].y[2] && "number" === typeof z[l].y[3] && "number" === typeof z[l].y[4] && 5 === z[l].y.length) {
                              ...
                              b.strokeStyle = e,
                              b.lineWidth = ba,
                              0 < ba && (b.moveTo(u - D - G, k),
                              b.lineTo(u - D - G, Math.max(h, p)),
                              b.stroke(),
                              b.moveTo(u - D - G, Math.min(h, p)),
                              b.lineTo(u - D - G, n),
                              b.stroke()),
                              ca(b, C, Math.max(k, n), B, Math.min(k, n), e, 0, null, !1, !1, !1, !1),
                              0 < P && (b.beginPath(),
                              b.lineWidth = P,
      ...
      m.prototype.renderRangeColumn = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = 0, l, u, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
      ...
      m.prototype.renderError = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = !1, l = this.plotArea, u = 0, h, k, n, p, q, g, r, m = a.axisX.dataInfo.minDiff;
                  ...
                  if (0 < C.length)
                      for (var F = E._colorSet, u = 0; u < C.length; u++) {
                          ...
                          if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(C[u].y) && C[u].y.length && "number" === typeof C[u].y[0] && "number" === typeof C[u].y[1]) {
                              ...
                              b ? p = ja : g = ja;
                              b ? (q = a.axisX.reversed ? k + (B ? w : 1) * t / 2 - (B ? D - 1 : 0) * t << 0 : k - (B ? w : 1) * t / 2 + (B ? D - 1 : 0) * t << 0,
      ...
      m.prototype.renderRangeBar = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = 0, l, u, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                      ...
                      for (var S = !0; g < p.length; g++)
                          ...
                          !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                              if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                  ...
                                  q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || B === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = D,
                                  ...
                                  b.strokeStyle = C,
                                  b.setLineDash && (p[g].lineDashType ? (B = p[g].lineDashType,
                                  h[h.length - 1].newLineDashArray = N(B, n.lineThickness),
                                  b.setLineDash(h[h.length - 1].newLineDashArray)) : (B = n.lineDashType,
                      ...
                      for (g = !1; p < n.length; p++)
                          ...
                          !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                              if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                  ...
                                  b.setLineDash && (n[p].lineDashType ? (E = n[p].lineDashType,
                                  ...
                                  0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = B,
                                  E = k.nullDataLineDashType) : (d(C, x),
                                  s = [],
                                  y = [])),
                                  g = !0;
                      d(C, x);
      ...
      m.prototype.renderWaterfall = function(a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx
            , c = v ? this._preRenderCtx : d;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, h, m, k, n, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                  ...
                  if (0 < w.length)
                      for (var z = 5 < q && s.bevelEnabled ? !0 : !1, E = !1, C = null, B = null, l = 0; l < w.length; l++)
                          if (w[l].getTime ? n = w[l].x.getTime() : n = w[l].x,
                          "number" !== typeof w[l].y) {
      ...
      m.prototype.renderPie = function(a) {
          function d() {
              if (k && n) {
                  ...
                  for (e = 0; e < n.length; e++)
                      p = g[(c + e) % n.length],
                      1 < a && (p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !h ? (p.hemisphere = "right",
                      f++) : (p.hemisphere = "left",
                      h = !0));
                  h = !1;
                  for (e = 0; e < n.length; e++)
                      p = g[(d + e) % n.length],
                      1 < b && (p.midAngle > 3 * Math.PI / 2 - t && p.midAngle < 3 * Math.PI / 2 + t) && (l <= b / 2 && !h ? (p.hemisphere = "left",
                      l++) : (p.hemisphere = "right",
                      h = !0))
              }
          }
          function c(a) {
          ...
          function f(a, c, d) {
              ...
              if (0 <= a && a < n.length) {
                  ...
                  q = e(a);
                  p = l = 0;
                  0 > c ? (p = "right" === h.hemisphere ? u : q,
                  k = c,
                  null !== p && (u = -c,
                  c = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - (g[p].indexLabelTextBlock.y + g[p].indexLabelTextBlock.height / 2),
                  c - u < r && (l = -u,
                  p = f(p, l, d + 1),
                  +p.toFixed(x) > +l.toFixed(x) && (k = c > r ? -(c - r) : -(u - (p - l)))))) : 0 < c && (p = "right" === h.hemisphere ? q : u,
                  k = c,
                  null !== p && (u = c,
                  c = g[p].indexLabelTextBlock.y - g[p].indexLabelTextBlock.height / 2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2),
                  c - u < r && (l = u,
                  p = f(p, l, d + 1),
                  +p.toFixed(x) < +l.toFixed(x) && (k = c > r ? c - r : u - (l - p)))));
                  k && (d = h.indexLabelTextBlock.y + k,
                  c = 0,
                  c = "right" === h.hemisphere ? z.x + Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)),
                  h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t ? (l = (a - 1 + g.length) % g.length,
                  l = g[l],
                  a = g[(a + 1 + g.length) % g.length],
                  "left" === h.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x - 15 : "right" === h.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t && (l = (a - 1 + g.length) % g.length,
                  l = g[l],
                  a = g[(a + 1 + g.length) % g.length],
                  "right" === h.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x + 15 : "left" === h.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
                  h.indexLabelTextBlock.y = d,
                  h.indexLabelTextBlock.x = c,
                  h.indexLabelAngle = Math.atan2(h.indexLabelTextBlock.y - z.y, h.indexLabelTextBlock.x - z.x))
              }
              return k
          }
          function l() {
              ...
              for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                      ...
                      for (var u, s, a = 0; a < n.length; a++) {
                          ...
                          if (null !== t) {
                              ...
                              if (0 > E) {
                                  ...
                                  var C = -1 * (E - s)
                                    , H = F = 0;
                                  "right" === h.hemisphere ? (F = f(a, s),
                                  C = -1 * (E - F),
                                  H = f(t, C),
                                  +H.toFixed(x) < +C.toFixed(x) && +F.toFixed(x) <= +s.toFixed(x) && f(a, -(C - H))) : (F = f(t, s),
                                  C = -1 * (E - F),
                                  H = f(a, C),
                                  +H.toFixed(x) < +C.toFixed(x) && +F.toFixed(x) <= +s.toFixed(x) && f(t, -(C - H)))
                              }
                          }
                      }
                  } else
                  ...
                  for (a = 0; a < n.length; a++)
                      ...
                      0 !== t.height && 0 !== t.width)
                          ...
                          Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - z.y) < B || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - z.y) < B) && (t /= Math.abs(Math.cos(h.indexLabelAngle)),
                          9 < t && (t *= 0.3),
                          t > d && (d = t)),
                          t = t = 0,
                          ...
                          0 < t && (!l && h.indexLabelText && (s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                          0 === f(a, t * s) && f(a, 2 * s)),
                          Math.abs(h.indexLabelTextBlock.x - z.x) < B && (t /= Math.abs(Math.sin(h.indexLabelAngle)),
                          9 < t && (t *= 0.3),
                          t > d && (d = t)));
          ...
          var m = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, r = 2, v, w = 1.3, t = 20 / 180 * Math.PI, x = 6, z = {
                  x: (q.x2 + q.x1) / 2,
                  y: (q.y2 + q.y1) / 2
              }, E = 0;
              a = !1;
              for (var C = 0; C < n.length; C++)
                  E += Math.abs(n[C].y),
                  !a && ("undefined" !== typeof n[C].indexLabel && null !== n[C].indexLabel && 0 < n[C].indexLabel.toString().length) && (a = !0),
                  !a && ("undefined" !== typeof n[C].label && null !== n[C].label && 0 < n[C].label.toString().length) && (a = !0);
              if (0 !== E) {
                  ...
                  this.pieDoughnutClickHandler = function(a) {
                      m.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
      ...
      m.prototype.renderFunnel = function(a) {
          ...
          function c() {
              ...
              for (var l = d[0] = 0, n = 0, h, p, b = b - a, l = !1, k = 0; k < x.length; k++)
                  ...
                  l ? h = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a,
                  0 > p ? (p = c,
                  l = (b + p) * (e - n) / 2,
                  a -= l,
                  h = e - n,
                  ...
                  h += 0 == p ? 0 : a / p,
                  n += a / p,
                  l = !0) : (h = (Math.abs($) * b - Math.sqrt(p)) / 2,
                  p = b - 2 * h / Math.abs($),
                  n += h,
                  n > e && (n -= h,
                  p = c,
          ...
          function b() {
              if (t && x) {
                  for (var a, b, c, d, e, f, k, l, n, h, p, q, u, m, r = [], A = [], w = {
                      ...
                      r[z] = J - m - V;
                  m = 0.5 * V;
                  for (var z = 0, B = x.length - 1; z < x.length || 0 <= B; z++,
                  B--) {
                      ...
                      20 > r[z] && (r[z] = z !== ca ? t.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1,
                      r[z] /= 2));
          ...
          function e() {
              ...
              if (e)
                  for (l = I.length - 1; 0 <= l; l--)
                      ...
                      t.reversed ? (I[l].textBlock.y + I[l].height > ma + E && (I[l].textBlock.y = ma + E - I[l].height),
          ...
          function f() {
              ...
              if ("inside" !== t.indexLabelPlacement)
                  for (var e = 0; e < O.length; e++)
                      0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e],
                      c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                      ...
                      t.reversed ? (I[e].textBlock.y + I[e].height > ma + E && (I[e].textBlock.y = ma + E - I[e].height),
                      I[e].textBlock.y < ra - E && (I[e].textBlock.y = ra - E)) : (I[e].textBlock.y < ma - E && (I[e].textBlock.y = ma - E),
                      I[e].textBlock.y + I[e].height > ra + E && (I[e].textBlock.y = ra + E - I[e].height)));
              else
          ...
          function l() {
              ...
              function b() {
                  ...
                  for (var l, h = 1; h < k; h++) {
                      ...
                      for (var u = I.length - 1; 0 <= u; u--)
                          !I[u].isDirty && (I[u].textBlock.y < e && I[u].textBlock.y + I[u].height > e) && (l = q(u),
                          !(l >= I.length - 1) && I[u].textBlock.y + I[u].height + da > I[l].textBlock.y && (I[u].textBlock.y = I[u].textBlock.y + I[u].height - e > e - I[u].textBlock.y ? e + 1 : e - I[u].height - 1))
                  }
              ...
              for (var d, e, f, g, k, l, n = 1, m = 0; m < 2 * n; m++) {
                  for (var r = I.length - 1; 0 <= r && !(0 <= p(r) && p(r),
                  f = I[r],
                  g = f.textBlock,
                  l = (k = q(r) < O.length ? I[q(r)] : null) ? k.textBlock : null,
                  d = +f.height.toFixed(6),
                  e = +g.y.toFixed(6),
                  !f.isDirty && (k && e + d + da > +l.y.toFixed(6)) && (d = g.y + d + da - l.y,
                  e = a(r, -d),
                  e < d && (0 < e && (d -= e),
                  e = a(q(r), d),
                  e != d))); r--)
          ...
          function m(a, b, c) {
              ...
              a._animator.animate(0, c, function(c) {
                  ...
                  w(d);
                  H && ("inside" !== t.indexLabelPlacement ? n(d) : f(),
                  r(d));
                  1 <= c && (ha = !1)
          ...
          function n(a) {
              for (var b, c, d, e, f = 0; f < O.length; f++)
                  ...
                  I[f].isDirty || 0 == I[f].lineThickness || (a.strokeStyle = I[f].lineColor,
          ...
          function r(a) {
              for (var b = 0; b < O.length; b++)
                  I[b].isDirty || (a && (I[b].textBlock.ctx = a),
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              for (var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, z = this.plotArea, E = 0.025 * z.width, C = 0.01 * z.width, B = 0, D = z.height - 2 * E, F = Math.min(z.width - 2 * C, 2.8 * z.height), H = !1, P = 0; P < x.length; P++)
                  if (!H && ("undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length) && (H = !0),
              ...
              if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                  ...
                  var C = P + a / 2
                    ...
                    , ra = t.reversed ? M : Q;
                  a = [];
                  var C = [], O = [], F = [], U = M, ca, $ = (wa - ma) / (K - Y), ea = -$, P = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d();
                  if (-1 !== P) {
                      if (t.reversed)
                          for (F.push(U),
                          G = P.length - 1; 0 < G; G--)
                      ...
                      if (t.reversed)
                          for (G = 0; G < P.length; G++)
                              F[G] < wa ? (a.push(K),
                              C.push(W),
                              ca = G) : (a.push((F[G] - ma + $ * Y) / $),
                              C.push((F[G] - ma + ea * Z) / ea));
                      else
                          for (G = 0; G < P.length; G++)
                              F[G] < wa ? (a.push((F[G] - ma + $ * Y) / $),
                              C.push((F[G] - ma + ea * Z) / ea),
                              ca = G) : (a.push(K),
                              C.push(W));
                      ...
                      for (G = 0; G < x.length; G++)
                          x[G].exploded && (P = !0,
                          t.reversed ? X.push(x.length - 1 - G) : X.push(G));
                      ...
                      "inside" !== t.indexLabelPlacement)) {
                          l();
                          for (G = 0; G < x.length; G++)
                              I[G].isDirty || (a = I[G].textBlock.x + I[G].width,
                              a = (J - a) / 2,
                              0 == G && (B = a),
                              B > a && (B = a));
                      ...
                      for (G = 0; G < O.length; G++)
                          B = O[G],
                          pa(R, B, t.fillOpacity),
                          ga.push(B.y1);
                      w(R);
                      H && t.visible && ("inside" === t.indexLabelPlacement || y.animationEnabled || n(R),
      ...
      F.prototype.setLayout = function() {
          ...
          l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical",
                                      ...
                                      if (s(this.options.labelWrap))
                                          if (!s(this.options.labelMaxWidth))
                                              ...
                                              q < f)
                                                  ...
                                                  this.sessionVariables.labelMaxHeight = l,
                                                  this.sessionVariables.labelAngle = this.labelAngle));
                                              else if (w === c && (0 === w && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > p || w === this._labels.length - 1 && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > p || 0 < w && w < this._labels.length - 1 && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > p && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > p))
                  ...
                  !this.chart.panEnabled && 1 <= this._labels.length) {
                      ...
                      for (c = 0; c < this._labels.length; c++)
                          if (!this._labels[c].breaksLabelType) {
                              ...
                              a.measureText()),
                              this.sessionVariables.labelMaxHeight = l,
                              this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : h >= 2.4 * l && h < 2.8 * l ? (this.sessionVariables.labelMaxHeight = b,
                              this.sessionVariables.labelFontSize = this.labelFontSize,
                              ...
                              this.sessionVariables.labelWrap = !0,
                              this.sessionVariables.labelFontSize = this.labelFontSize) : h > 3.6 * l && h < 10 * l ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                              a.measureText()),
                              this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                              this.sessionVariables.labelMaxWidth = f,
                              this.sessionVariables.labelMaxHeight = l,
                              ...
                              s(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : b,
                              this.sessionVariables.labelWrap = this.labelWrap,
          ...
          if ("normal" === e) {
              for (var x = [], z = [], y = [], C = [], M = [], N = [], Q = [], R = []; 4 > v; ) {
                  ...
                  if (b && 0 < b.length)
                      for (C = [],
                      g = $ = 0; g < b.length; g++)
                          C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
                          $ += C[g],
                          Z += b[g] ? b[g].margin : 0;
                  else
                  ...
                  if (a && 0 < a.length)
                      for (g = 0; g < a.length; g++)
                          ...
                          a[g]._labels && 1 < a[g]._labels.length && (B = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1,
                          l = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position,
                          l = a[g].getApparentDifference(a[g].viewportMinimum, l),
                          D = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                  if (d && 0 < d.length)
                      for (g = 0; g < d.length; g++)
                          d[g].calculateValueToPixelConversionParameters(),
                          d[g].calculateBreaksSizeInValues(),
                          d[g]._labels && 1 < d[g]._labels.length && (B = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                          l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position,
                          l = d[g].getApparentDifference(d[g].viewportMinimum, l),
                          D = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                  for (g = 0; g < q.length; g++)
              ...
              for (N = []; 4 > v; ) {
                  ...
                  if (c && 0 < c.length)
                      for (g = 0; g < c.length; g++)
                          ...
                          0 < !d.length && (m = 0 < c[g].labelAngle ? m - z / 2 : 0 === c[g].labelAngle ? m - z / 2 : m)),
                  ...
                  if (b && 0 < b.length)
                      for (B = [],
                      g = T = 0; g < b.length; g++)
                          B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
                          T += B[g],
                          Z += b[g].margin;
                  else
                      ...
                      for (g = 0; g < a.length; g++) {
                          ...
                          if (c && 0 < c.length)
                              for (K = 0; K < c.length; K++)
                                  c[K] && c[K].labelAutoFit && (m = 0 > c[K].labelAngle ? Math.max(m, x) : 0 === c[K].labelAngle ? Math.max(m, x / 2) : m,
                                  l = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? m - Y : l);
                          if (b && 0 < b.length)
                              for (K = 0; K < b.length; K++)
                                  b[K] && b[K].labelAutoFit && (m = b[K].lineCoordinates.x1,
                                  l = m - Y);
                          a[g].lineCoordinates = {
                              x1: m - Q,
                              y1: h,
                  ...
                  if (d && 0 < d.length)
                      for (g = 0; g < d.length; g++) {
                          ...
                          if (b && 0 < b.length)
                              for (K = 0; K < b.length; K++)
                                  b[K] && b[K].labelAutoFit && (m = b[K].lineCoordinates.x2,
                                  l = m - U);
                          d[g].lineCoordinates = {
                              x1: m + R,
                              y1: h,
                  ...
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, h = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                          ...
                          if (p.position < this.viewportMinimum)
                              break;
                          p.position > this.viewportMaximum || !(k === this._labels.length - 1 || l < Math.log(h / p.position) * m / e) || (c.push(p),
                          h = p.position,
              ...
              if ("left" === this._position || "right" === this._position)
                  if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                      for (var c = [], n, h = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                          ...
                          if (p.position < this.viewportMinimum)
                              break;
                          p.position > this.viewportMaximum || !(k === this._labels.length - 1 || n < Math.log(h / p.position) * m) || (c.push(p),
                          h = p.position,
      ...
      D.prototype.createMask = function() {
          if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
              ...
              v ? (this.maskCanvas = sa(this.chart.width, this.chart.height),
      ...
      D.prototype.renderAxisLine = function() {
          var a = this.chart.ctx, d = v ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f;
          d.save();
          if ("bottom" === this._position || "top" === this._position) {
      ...
      D.prototype.calculateAxisParameters = function() {
          if (this.logarithmic)
              ...
              if ("axisX" === this.type && c) {
                  ...
                  this.intervalType = "millisecond") : b / (1 * R.secondDuration) <= a ? (this.interval = 1,
      ...
      D.prototype.calculateLogarithmicAxisParameters = function() {
          ...
          this.options && "undefined" === typeof this.options.interval && (this.interval = D.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1)),
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  ...
                  for (var w = 0; w < this.parent.dataSeries.length; w++)
                      (v = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w],
                  ...
                  if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                      for (var v = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])), t = 0, r = 0; r < n.length; r++)
                          if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                              for (var x = 0; x < n[r].dataPoint.y.length; x++)
                                  t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
                                  t < v && (v = t,
                                  w = r);
                          else
                      ...
                      for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = z = t = 0, r = 0; r < n.length; r++)
                          if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                              for (x = 0; x < n[r].dataPoint.y.length; x++)
                                  t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
                                  t < v && (v = t,
                              ...
                              z += n[r].dataPoint.y,
                              y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x,
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      ...
                      if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                          ...
                          for (r = t = 0; r < x.dataPoint.y.length; r++)
                              t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[r])),
                              t < v && (v = t,
                              b = r);
                  ...
                  if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type)
                      ...
                      r = t = 0; r < n.length; r++)
                          if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                              for (x = 0; x < n[r].dataPoint.y.length; x++)
                                  t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
                                  t < v && (v = t,
                                  w = r);
                          else
                  ...
                  if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                      ...
                      for (r = t = 0; r < x.dataPoint.y.length; r++)
                          t = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])),
                          t < v && (v = t,
                          b = r);
                      ...
                      "waterfall" === this.parent.dataSeries[w].type ? (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0,
                      k.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart,
                          axis: this.parent.options,
                          crosshair: this.options,
                      ...
                      if (this.chart.axisX)
                          for (var m = 0; m < this.chart.axisX.length; m++) {
                              for (var l = this.chart.axisX[m].convertPixelToValue({
                                  ...
                                  (k = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[m].dataSeries[b],
                      ...
                      if (this.chart.axisX2)
                          for (m = 0; m < this.chart.axisX2.length; m++) {
                              ...
                              for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                                  (k = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[m].dataSeries[b],
                                  null !== k.dataPoint.y && h.push(k));
                              k = null
                          }
                  } else {
      ...
      Y.prototype.highlightObjects = function(a) {
          ...
          for (c = 0; c < a.length; c++) {
              ...
              if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                  ...
                  f.borderColor = f.borderColor || "#FFFFFF",
                  f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                  W.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                  f.size = e.size,
                  f.color = "white",
                  f.borderColor = "white",
                  d.globalAlpha = 0.3,
                  W.drawMarkers([f]),
                  d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ca(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? X(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? pa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
      ...
      Y.prototype.getToolTipInnerHTML = function(a) {
          ...
          if (h && (this.content && "function" === typeof this.content || this.contentFormatter))
              ...
              for (var s = null, k = "", m = 0; m < a.length; m++)
                  ...
                  e = a[m].index,
                  f = "",
                  0 === m && (h && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? k += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (k += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"),
                  k += "</br>",
